...
var mokuai;
(function (mokuai) {
    var WJX = (function (_super) {
        __extends(WJX, _super);
        function WJX(scene, posX, posY, sf, mass, type, peise, pz_numb, k) {
            var _this = this;
            if (k) {
        ...
        WJX.prototype.initColl = function () {
            ...
            this.boxShape3.collisionGroup = mokuai.mokuai_cr;
            this.boxShape4.collisionMask = mokuai.mokuai_cr;
            this.boxShape4.collisionGroup = mokuai.mokuai_cr;
            this.boxShape5.collisionMask = mokuai.mokuai_cr;
            this.boxShape5.collisionGroup = mokuai.mokuai_cr;
        };
        WJX.prototype.initShape = function () {
        ...
        // }
        //初始化刚体位置
        WJX.prototype.initPost = function () {
            //设置y轴坐标
    ...
    mokuai.WJX = WJX;
    __reflect(WJX.prototype, "mokuai.WJX");
})(mokuai || (mokuai = {}));
//# sourceMappingURL=WJX.js.map